...
public class RNConcursando extends RNPessoa {
	...
	public Concursando logarConcursando(String login, String senha)
		...
		if (concursandos.size() <= 0 || concursandos == null) {
	...
	public List<CartaoResposta> consultarCartoesRespostaConcursandoProva(
			Prova prova, Concursando concursando) throws Exception {
