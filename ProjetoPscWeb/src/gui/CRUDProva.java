...
public class CRUDProva extends javax.swing.JFrame {
	...
	public CRUDProva() {
		try {
			initComponents();
			questoesMultiplaEscolha = (ArrayList<QuestaoMultiplaEscolha>) fachada
					.consultarTodosQuestaoMultiplaEscolha();
			questoesDiscursiva = (ArrayList<QuestaoDiscursiva>) fachada
	...
	public void carregarListaQuestoesMultiplaEscolha() {
		try {
			...
			for (QuestaoMultiplaEscolha questMult : questoesMultiplaEscolha) {
				modelo.addRow(new Object[] { questMult.getTexto(),
						questMult.getReferencia(),
						questMult.getGenero().getGenero() });
			}
	...
	public void carregarListaQuestoesDiscursiva() {
		try {
			...
			for (QuestaoDiscursiva questDisc : questoesDiscursiva) {
				modelo.addRow(new Object[] { questDisc.getTexto(),
						questDisc.getReferencia(),
						questDisc.getGenero().getGenero() });
			}
	...
	public void carregarListaQuestoesEscolhidas() {
		try {
			...
			for (Questao questao : questoesEscolhidas) {
				modelo.addRow(new Object[] { questao.getTexto(),
						questao.getReferencia(),
						questao.getGenero().getGenero() });
			}
	...
	public void gerarProva() {
		try {
			...
			diaFase = fachada
					.consultarDiaFasePorId(codDiaFase[ComboDiaFaseProva
							.getSelectedIndex()]);
			...
			provaPDF.add(image);
			provaPDF.add(new Paragraph(
					"Nome do Concursando:_____________________________________________________________",
					font));
			SimpleDateFormat formatoData = new SimpleDateFormat("dd-MM-yyyy");
			SimpleDateFormat formatoHora = new SimpleDateFormat("HH:mm");
			provaPDF.add(new Paragraph("Matéria sendo Avaliada: "
					+ fachada.consultarGeneroPorId(prova.getGenero().getId())
							.getGenero()
					+ "                                      Data: "
					+ formatoData.format(diaFase.getDataDia().getTime())
							.toString(), font));
			Paragraph nomeConcurso = new Paragraph(new Paragraph("Concurso "
					+ diaFase.getFase().getAreaconcurso().getConcurso()
							.getNomeConcurso(), font));
			nomeConcurso.setAlignment(Element.ALIGN_CENTER);
			provaPDF.add(new Paragraph("Área do Concurso: "
					+ diaFase.getFase().getAreaconcurso().getNome(), font));
			provaPDF.add(new Paragraph("Início da Prova: "
					+ formatoHora.format(diaFase.getHoraInicial().getTime())
							.toString()
					+ "     Término da Prova: "
					+ formatoHora.format(diaFase.getHoraFinal().getTime())
							.toString(), font));
			...
			for (Questao questao : prova.getQuestoes()) {
				String referencia = "";
				if (questao.getReferencia() != null
						&& !questao.getReferencia().trim().equals("")) {
					referencia = "(" + questao.getReferencia() + ")";
				}
				provaPDF.add(new Paragraph(4, numQuestao++ + "ª) " + referencia
						+ questao.getTexto(), font));
				if (questao instanceof QuestaoMultiplaEscolha) {
					int i = 0;
					QuestaoMultiplaEscolha questaoMultiplaEscolha = (QuestaoMultiplaEscolha) questao;
					for (Alternativa alternativa : questaoMultiplaEscolha
							.getAlternativas()) {
						provaPDF.add(new Paragraph(letras.charAt(i) + ") "
								+ alternativa.getTexto(), font));
						i++;
					}
			 ...
			 * cr.setProva(prova); /*Concursando concursando = new
			 * Concursando(); concursando.setId(2);
			...
			if (JOptionPane.showConfirmDialog(rootPane,
					"Prova Gerada com Sucesso. \n Gostaria de visualiza-la?",
					"Visualizar Prova", JOptionPane.YES_NO_OPTION) == 0) {
	...
	private void initComponents() {
		...
		TableQuestoesMultiplaEscolhaProva
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { {}, {}, {}, {} }, new String[] {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		try {
			...
			int questMult = Integer
					.parseInt(JOptionPane
							.showInputDialog("Informe o número de questões de multipla escolha: "));
			int questDisc = Integer
					.parseInt(JOptionPane
							.showInputDialog("Informe o número de questões discussivas escolha: "));
			...
			questoesDiscursivas = (ArrayList<QuestaoDiscursiva>) fachada
					.consultarTodosPorGeneroQuestaoDiscursiva(genero);
			questoesMultiplaEscolhas = (ArrayList<QuestaoMultiplaEscolha>) fachada
					.consultarTodosPorGeneroQuestaoMultiplaEscolha(genero);
			for (int i = 0; i < questDisc; i++) {
				QuestaoDiscursiva questaoDiscursiva = new QuestaoDiscursiva();
				questaoDiscursiva = questoesDiscursivas.get(new Random()
						.nextInt(questoesDiscursivas.size()));
			...
			for (int i = 0; i < questMult; i++) {
				...
				questaoMultiplaEscolha = questoesMultiplaEscolhas
						.get(new Random().nextInt(questoesMultiplaEscolhas
								.size()));
	...
	private void ComboConcursoProvaActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ComboConcursoProvaActionPerformed
		// TODO add your handling code here:
		...
		try {
			...
			concurso = fachada
					.consultarConcursoPorId(codConcurso[ComboConcursoProva
							.getSelectedIndex()]);
	...
	private void ComboAreaConcursoProvaItemStateChanged(
			java.awt.event.ItemEvent evt) {// GEN-FIRST:event_ComboAreaConcursoProvaItemStateChanged
		// TODO add your handling code here:
	}// GEN-LAST:event_ComboAreaConcursoProvaItemStateChanged

	private void ComboAreaConcursoProvaActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ComboAreaConcursoProvaActionPerformed
		// TODO add your handling code here:
		try {
			// TODO add your handling code here:
			AreaConcurso areaConcurso = new AreaConcurso();
			areaConcurso = fachada
					.consultarAreaConcursoPorId(codAreaConcurso[ComboAreaConcursoProva
							.getSelectedIndex()]);
	...
	private void ComboFaseProvaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ComboFaseProvaActionPerformed
		...
		try {
			// TODO add your handling code here:
			Fase fase = new Fase();
			fase = fachada.consultarFasePorId(codFase[ComboFaseProva
					.getSelectedIndex()]);
			...
			for (DiaFase diafase : fase.getDiasFase()) {
				...
				boxModel.addElement(format.format(diafase.getDataDia()
						.getTime()));
	...
	private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton5ActionPerformed
		// TODO add your handling code here:
		questoesEscolhidas.add(questoesMultiplaEscolha
				.get(TableQuestoesMultiplaEscolhaProva.getSelectedRow()));
		questoesMultiplaEscolha.remove(TableQuestoesMultiplaEscolhaProva
				.getSelectedRow());
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		// TODO add your handling code here:
		questoesEscolhidas.add(questoesDiscursiva
				.get(TableQuestoesDiscursivaProva.getSelectedRow()));
		questoesDiscursiva
				.remove(TableQuestoesDiscursivaProva.getSelectedRow());
		this.carregarListaQuestoesEscolhidas();
		this.carregarListaQuestoesDiscursiva();
	...
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
		...
		questao = questoesEscolhidas.get(TableQuestoesEscolhidasprova
				.getSelectedRow());
	...
	private void ButtonSalvarProvaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ButtonSalvarProvaActionPerformed
		...
		try {
			if (ComboGeneroProva.getSelectedIndex() == -1) {
				...
				prova.setPesoMultipla(Integer.parseInt(textPesoMultiplaProva
						.getText()));
				prova.setPesoDiscursiva(Integer.parseInt(textPesoDiscursoProva
						.getText()));
			...
			Logger.getLogger(CRUDProva.class.getName()).log(Level.SEVERE, null,
					ex);
		}
	}

	private void ButtonCadastrarQuestoesProvaActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ButtonCadastrarQuestoesProvaActionPerformed
		// TODO add your handling code here:
		try {
			CRUDQuestao crudq;
			...
			if (concursos.size() <= 0) {
				JOptionPane
						.showMessageDialog(rootPane,
								"Não há Concursos cadastrados, cadastre um concurso para prosseguir");
				this.dispose();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CRUDProva.class.getName()).log(
