...
public class ListarConcurso extends javax.swing.JFrame {
	...
	public void carregarTabelaConcurso() {
		try {
			...
			modelo.setColumnIdentifiers(new String[] { "Id", "NomeConcurso",
					"NomeEmpresa", "Data", "DataFinal" });
			...
			for (Concurso concurso : concursos) {
				...
				modelo.addRow(new Object[] { (concurso.getId()),
						concurso.getNomeConcurso(),
						concurso.getEmpresa().getNome(),
						sdf.format(concurso.getDatainscricao().getTime()),
						sdf.format(concurso.getDatafinal().getTime()) });
			}
	...
	private void buttonRemoverConcursoActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonRemoverConcursoActionPerformed
		// TODO add your handling code here:mo
		if (TabelaListarConcurso.getSelectedRow() == -1) {
			JOptionPane.showMessageDialog(rootPane,
					"Selecione um concurso para remover");
		} else {
			Concurso concurso = new Concurso();
			try {
				int codigo = TabelaListarConcurso.getSelectedRow();
				concurso = fachada.consultarConcursoPorId(Long
						.parseLong(TabelaListarConcurso.getValueAt(codigo, 0)
								.toString()));
	...
	private void buttonAlterarConcursoActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonAlterarConcursoActionPerformed
		// TODO add your handling code here:
		if (TabelaListarConcurso.getSelectedRow() == -1) {
			JOptionPane.showMessageDialog(rootPane,
					"Selecione um concurso para alterar");
		} else {
			Concurso concurso = new Concurso();
			try {
				int codigo = TabelaListarConcurso.getSelectedRow();
	...
	private void ButtonCadastrarConcursoActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ButtonCadastrarConcursoActionPerformed
		// TODO add your handling code here:
	...
	private void ButtonListarConcursoActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ButtonListarConcursoActionPerformed
		// TODO add your handling code here:
		this.carregarTabelaConcurso();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ListarConcurso.class.getName())
